...
import { NotificationSettings, SubscriptionTopics } from "@/lib/types";
import {
  FetchStatus,
...
export default function SubscribeForm({
  ...
  const subscriptionTopics = defaultTopics
    ? [...defaultTopics, NEW_FEATURES_NOTIFICATION_SETTING]
    : NOTIFICATION_SETTINGS;
  ...
  const switchOnClick = (topic: SubscriptionTopic, topicTitle: string) => {
